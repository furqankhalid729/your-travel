...
const AddTourBooking = () => {
  ...
  const handleSubmit = (e) => {
    ...
    post("/add-tour-booking", formData, {
      onSuccess: () => {
        setMessage("add-tour-booking added successfully!");
      },
    });
  };
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              ...
              <div>
                <input
                  type="number"
                  placeholder="Identity Number"
                  value={member.identityNo}
                  onChange={(e) => handleMemberChange(index, "identityNo", e.target.value)}
                  className="p-3 w-full border border-gray-300 rounded-md"
                />
              </div>
