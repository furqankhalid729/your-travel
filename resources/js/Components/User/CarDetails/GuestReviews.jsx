...
const GuestReviews = () => {
  ...
  const ratings = [
    { name: "Performance", value: 4.6 },
    { name: "Condition", value: 4.7 },
  ...
  return (
    <section className="my-8">
      ...
      <div className="md:flex items-start gap-10">
        <div className="mb-8 md:mt-0 md:w-[25%]">
        ...
        <div className="flex-1 grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4 md:mt-0">
